...
class _State extends ConsumerState<StudentVideosScreen> {
  ...
  Future<void> _load() async {
    final data = await supabase.from('videos').select('id, title, subject, thumbnail_url, classes(name), teachers(profiles(name))').order('created_at', ascending: false);
            ...
            return Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Container(
                  ...
                  child: v['thumbnail_url'] == null ? Center(child: Icon(Icons.play_circle_fill_rounded, size: 48, color: AppColors.primary)) : null,
                ),
                Padding(
